...
interface = "/Users/annie/emap/alanine_scanning.txt"
...
# assign interface vs. non-interface classification for mutations
# get residue number from number in mutant id

# interface if abs val score is > 0.5
